...
class DCPicCell: DCBaseCell {
    ...
    UILabel(text: nil, font:ftSystem(10), textColor: UIColor(white: 0.5, alpha: 1), Alignment:.Right)
    private  let titleLable =
    UILabel(text: nil, font: ftBold(12), textColor:UIColor.blackColor(), Alignment: .Left)
